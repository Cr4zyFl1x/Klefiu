...
if (isset($_GET['check'])) {
    ...
    if (!$error) {
        ...
        $result['panel_navigationTitle']            = $query->execute(array('settingNr' => 109, 'settingID' => "panel_navigationTitle", 'settingVal' => 'UCMS - App', 'settingDescription' => "Navigation title -> string"));
        $result['panel_title']                      = $query->execute(array('settingNr' => 110, 'settingID' => "panel_title", 'settingVal' => 'UCMS', 'settingDescription' => "Panel title -> string"));
        ...
        $result['mail_automatic_sendername']        = $query->execute(array('settingNr' => 201, 'settingID' => "mail_automatic_sendername", 'settingVal' => 'Klefiu - File uploader', 'settingDescription' => "Name displayed as Sender -> string"));
