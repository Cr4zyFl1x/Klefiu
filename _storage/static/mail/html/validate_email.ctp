                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent">
                                                ...
                                                <p>You created a request to update your profiles email address a few seconds ago. <br /><?= $data['oldEmail'] . '&nbsp;&nbsp;->&nbsp;&nbsp;' . $data['newEmail']; ?></p>
                                                <p>To verify your identity and to go on with the email change process please click here:<br /><a href="<?=$data['validationLink']; ?>"><?=$data['validationLink']; ?></a></p>
                                                <p>If you never requested an email change, please change your password and cancel the request here:<br /><a href="<?=$data['validationLink'] . '/cancel'; ?>"><?=$data['validationLink'] . '/cancel'; ?></a></p>
                                                <p>If you need further help, please contact the site administrator.</p>
                                                <p>Regards,<br /><?= $data['app']->utils()->getSetting('panel_operatorName'); ?></p>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent">
                                                ...
                                                <?=$data['app']->utils()->getSetting('panel_copyrightInfo'); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
