...
function updateSQLConfig($db_host, $db_port, $db_user, $db_name, $db_pass) {
    ...
    fwrite($file,"\n\r");
    fwrite($file,'// Use Klefiu\SQL & Klefiu\Config as namespace'); fwrite($file,"\n");
    fwrite($file,'use Klefiu\Config;'); fwrite($file,"\n");
    fwrite($file,'use Klefiu\SQL;');
    fwrite($file,"\n\r");
    ...
    fwrite($file,'Config::write(\'db_port\', '.$db_port.');');
    fwrite($file,"\n\r");
